...
@section('content')
  <div class="well">
    ...
    <p>
      ...
      먼저 정적 변수라는 것 왜 필요한지 알아보기 위해, 변수의 값을 1씩 순차적으로 증가시키는 간단한 프로그램을 보시겠습니다.<br/>
...
?&gt</pre>
      ...
      그런데 위 프로그램을 실행하면 우리가 기대하는 것과는 다르게 아래와 같은 결과를 얻게 될 것입니다.<br/><br/>
      ...
      그럼 위 예제코드에 정적 변수를 사용해 수정하면 코드는 다음과 같을 것입니다.<br/><br/>
...
?&gt</pre>
      ...
      그리고 위 프로그램의 결과는 우리가 기대하는 것처럼 아래와 같을 것입니다.<br/><br/>
