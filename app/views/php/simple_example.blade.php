...
@section('content')
  <div class="well">
    ...
    <p>
      ...
      그럼, 이제 편집 프로그램을 실행하신 후에 다음과 같이 입력해보세요.
    </p>
...
?&gt</pre>
      ...
      <p>
        ...
        만일 아파치 웹서버의 기본적인 셋팅환경에서 테스트하시는 경우 hello.php 파일을 아파치가 설치된 경로 안의 htdocs 디렉토리에 저장해보세요.<br/> 
        그리고 아래와 같이 웹브라우저 주소창에 입력하신 후 확인해보세요.
      </p>
...
?&gt</pre>
      ...
      <p>
        ...
        그리고 echo '...' 명령어는 문자열을 출력하는 기능을 수행하며, 따라서 위 예제 코드에서는 따옴표로 묶여진 문자열인 'Hello World' 가 화면에 보여지게 됩니다.<br/><br/>
