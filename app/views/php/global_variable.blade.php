...
?&gt</pre>
      ...
      하지만, 위 예제코드의 결과를 확인하면 아래와 같습니다.<br/><br/>
      ...
      따라서, 위 예제코드를 다음과 같이 수정하시면 됩니다.<br/><br/>
...
?&gt</pre>
      ...
      이제, 위 예제코드를 웹브라우저에서 다시 확인하면 아래와 같은 결과를 확인하실 수 있습니다.<br/><br/>
      ...
      전역 변수가 사용된 또 다른 예제코드를 보시겠습니다.<br/><br/>
...
?&gt</pre>
      ...
      최초 10이라는 값을 가진 $count 변수에 1을 두 번 더하게 되어 아래와 같이 12라는 값이 출력됩니다.<br/><br/>
